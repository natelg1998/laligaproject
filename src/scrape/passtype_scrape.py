...
def get_passing_data(url):
    ...
    pass_links = [l for l in pass_links if l and "matchlogs/all_comps/passing_types" in l]
...
if __name__ == "__main__":
    ...
    shooting_df.to_csv(os.path.join(os.path.realpath("./data/fbref_data/"), r"passing_types.csv"))
    end = time.time()
