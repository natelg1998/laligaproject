...
# test = pd.read_html("https://fbref.com/en/squads/206d90db/2021-2022/Barcelona-Stats", match="Scores & Fixtures")[0]
# print(type(test))
# team_name = "https://fbref.com/en/squads/206d90db/2021-2022/Barcelona-Stats".split("/")[-1].replace("-Stats", "").replace("-", " ")
# # scores.append(test)
# # print(scores)
# test_df = test
# test_df['Team'] = team_name
# print(test_df.head())
# test_df.to_csv(os.path.join(os.path.realpath("../../data/"), r"test.csv"))
# print(os.path.realpath("./data"))
# print(get_score_links())
